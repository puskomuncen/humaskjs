...
class Home
{
	...
	// Page object name
    public string $PageObjName = "home"; // Modified by Masino Sinaga, December 18, 2023
    ...
    public string $CurrentPageName = "homecontroller";
    ...
    public function __construct(protected Language $language, protected AdvancedSecurity $security)
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'home.php');
        }
...
// Use layout
    ...
    {
        Breadcrumb()->add("custom", "home", CurrentUrl(), "", "home", true);
        $this->Heading = Language()->tablePhrase("home", "TblCaption");
    }
