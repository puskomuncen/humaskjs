 ...
 * Page class
 */
class SettingsDelete extends Settings
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "SettingsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "settingsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("settingslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("settingslist"); // Return to list
                return;
            }
        }
