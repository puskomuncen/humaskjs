 ...
 * Page class
 */
class HelpCategoriesDelete extends HelpCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "HelpCategoriesDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "helpcategoriesdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("helpcategorieslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("helpcategorieslist"); // Return to list
                return;
            }
        }
