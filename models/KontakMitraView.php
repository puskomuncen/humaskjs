 ...
 * Page class
 */
class KontakMitraView extends KontakMitra
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KontakMitraView";
    ...
    // CSS class/style
    public string $CurrentPageName = "kontakmitraview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("kontak_id") ?? Route("kontak_id")) !== null) {
            $this->RecKey["kontak_id"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("kontak_id") ?? Route("kontak_id")) !== null) {
            ...
            $this->RecKey["kontak_id"] = $this->kontak_id->QueryStringValue;
        } elseif (Post("kontak_id") !== null) {
            $this->kontak_id->setFormValue(Post("kontak_id"));
            $this->RecKey["kontak_id"] = $this->kontak_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->kontak_id->setQueryStringValue($keyValue);
            $this->RecKey["kontak_id"] = $this->kontak_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "kontakmitralist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kontakmitralist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->kontak_id->CurrentValue, $this->CurrentRow['kontak_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kontakmitralist"; // No matching record, return to list
                    } else {
