...
/**
 * Table class for mitra
 */
class Mitra extends DbTable implements LookupTableInterface
{
    ...
    public DbField $nama_mitra;
    public DbField $jenis_mitra;
    public DbField $alamat;
    public DbField $email;
    public DbField $telepon;
    public DbField $tanggal_bergabung;
    public DbField $status_aktif;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "mitra"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->mitra_id->IsAutoIncrement = true; // Autoincrement field
        $this->mitra_id->IsPrimaryKey = true; // Primary key field
        ...
        // nama_mitra
        $this->nama_mitra = new DbField(
            $this, // Table
            'x_nama_mitra', // Variable name
            'nama_mitra', // Name
            '`nama_mitra`', // Expression
            '`nama_mitra`', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nama_mitra`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nama_mitra->InputTextType = "text";
        $this->nama_mitra->Nullable = false; // NOT NULL field
        $this->nama_mitra->Required = true; // Required field
        $this->nama_mitra->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['nama_mitra'] = &$this->nama_mitra;

        // jenis_mitra
        $this->jenis_mitra = new DbField(
            $this, // Table
            'x_jenis_mitra', // Variable name
            'jenis_mitra', // Name
            '`jenis_mitra`', // Expression
            '`jenis_mitra`', // Basic search expression
            200, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`jenis_mitra`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->jenis_mitra->InputTextType = "text";
        $this->jenis_mitra->Raw = true;
        $this->jenis_mitra->Nullable = false; // NOT NULL field
        $this->jenis_mitra->Required = true; // Required field
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->jenis_mitra->Lookup = new Lookup($this->jenis_mitra, 'mitra', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->jenis_mitra->Lookup = new Lookup($this->jenis_mitra, 'mitra', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
        ...
        $this->jenis_mitra->OptionCount = 4;
        $this->jenis_mitra->SearchOperators = ["=", "<>"];
        $this->Fields['jenis_mitra'] = &$this->jenis_mitra;
        ...
        // telepon
        $this->telepon = new DbField(
            $this, // Table
            'x_telepon', // Variable name
            'telepon', // Name
            '`telepon`', // Expression
            '`telepon`', // Basic search expression
            200, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`telepon`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->telepon->InputTextType = "text";
        $this->telepon->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['telepon'] = &$this->telepon;

        // tanggal_bergabung
        $this->tanggal_bergabung = new DbField(
            $this, // Table
            'x_tanggal_bergabung', // Variable name
            'tanggal_bergabung', // Name
            '`tanggal_bergabung`', // Expression
            CastDateFieldForLike("`tanggal_bergabung`", 0, "DB"), // Basic search expression
            133, // Type
            10, // Size
            0, // Date/Time format
            false, // Is upload field
            '`tanggal_bergabung`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tanggal_bergabung->InputTextType = "text";
        $this->tanggal_bergabung->Raw = true;
        $this->tanggal_bergabung->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
        $this->tanggal_bergabung->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['tanggal_bergabung'] = &$this->tanggal_bergabung;

        // status_aktif
        $this->status_aktif = new DbField(
            $this, // Table
            'x_status_aktif', // Variable name
            'status_aktif', // Name
            '`status_aktif`', // Expression
            '`status_aktif`', // Basic search expression
            16, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`status_aktif`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->status_aktif->addMethod("getDefault", fn() => 1);
        $this->status_aktif->InputTextType = "text";
        $this->status_aktif->Raw = true;
        $this->status_aktif->setDataType(DataType::BOOLEAN);
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status_aktif->Lookup = new Lookup($this->status_aktif, 'mitra', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->status_aktif->Lookup = new Lookup($this->status_aktif, 'mitra', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
        ...
        $this->status_aktif->OptionCount = 2;
        $this->status_aktif->DefaultErrorMessage = $this->language->phrase("IncorrectValueRegExp");
        $this->status_aktif->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['status_aktif'] = &$this->status_aktif;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "mitra";
    }
    ...
    public function insert(array &$row): int|bool
    {
        ...
        if ($result) {
            $this->mitra_id->setDbValue($conn->lastInsertId());
            $row['mitra_id'] = $this->mitra_id->DbValue;
        }
        return $result;
    }
    ...
    public function update(array $row, string|array $where = "", ?array $old = null, bool $currentFilter = true): int|bool
    {
        ...
        if ($success) {
            if (!isset($row['mitra_id']) && !IsEmpty($this->mitra_id->CurrentValue)) {
                $row['mitra_id'] = $this->mitra_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(?array $row, string|array $where = ""): QueryBuilder
    {
        ...
        $where = is_array($where) ? $this->arrayToFilter($where) : $where;
        if ($row) {
            if (array_key_exists('mitra_id', $row)) {
                AddFilter($where, QuotedName('mitra_id', $this->Dbid) . '=' . QuotedValue($row['mitra_id'], $this->mitra_id->DataType, $this->Dbid));
            }
        }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->nama_mitra->DbValue = $row['nama_mitra'];
        $this->jenis_mitra->DbValue = $row['jenis_mitra'];
        $this->alamat->DbValue = $row['alamat'];
        $this->email->DbValue = $row['email'];
        $this->telepon->DbValue = $row['telepon'];
        $this->tanggal_bergabung->DbValue = $row['tanggal_bergabung'];
        $this->status_aktif->DbValue = $row['status_aktif'];
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->mitra_id->CurrentValue : $this->mitra_id->OldValue;
        if (IsEmpty($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey(string $key, bool $current = false, ?string $keySeparator = null): void
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->mitra_id->CurrentValue = $keys[0];
            } else {
                $this->mitra_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter(?array $row = null, bool $current = false): string
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('mitra_id', $row) ? $row['mitra_id'] : null;
        } else {
            $val = !IsEmpty($this->mitra_id->OldValue) && !$current ? $this->mitra_id->OldValue : $this->mitra_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@mitra_id@", AdjustSql($val), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("mitralist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "mitraview" => $this->language->phrase("View"),
            "mitraedit" => $this->language->phrase("Edit"),
            "mitraadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MitraView",
            Config("API_ADD_ACTION") => "MitraAdd",
            Config("API_EDIT_ACTION") => "MitraEdit",
            Config("API_DELETE_ACTION") => "MitraDelete",
            Config("API_LIST_ACTION") => "MitraList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("mitraview", $parm);
        } else {
            $url = $this->keyUrl("mitraview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mitraedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mitralist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("mitralist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("mitradelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"mitra_id\":" . VarToJson($this->mitra_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->mitra_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->mitra_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys(): array
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("mitra_id") ?? Route("mitra_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys(bool $setCurrent = true): string
    {
        ...
        foreach ($arKeys as $key) {
            if ($setCurrent) {
                $this->mitra_id->CurrentValue = $key;
            } else {
                $this->mitra_id->OldValue = $key;
            }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->nama_mitra);
                    $doc->exportCaption($this->jenis_mitra);
                    $doc->exportCaption($this->alamat);
                    $doc->exportCaption($this->email);
                    $doc->exportCaption($this->telepon);
                    $doc->exportCaption($this->tanggal_bergabung);
                    $doc->exportCaption($this->status_aktif);
                } else {
                    $doc->exportCaption($this->mitra_id);
                    $doc->exportCaption($this->nama_mitra);
                    $doc->exportCaption($this->jenis_mitra);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->nama_mitra);
                        $doc->exportField($this->jenis_mitra);
                        $doc->exportField($this->alamat);
                        $doc->exportField($this->email);
                        $doc->exportField($this->telepon);
                        $doc->exportField($this->tanggal_bergabung);
                        $doc->exportField($this->status_aktif);
                    } else {
                        $doc->exportField($this->mitra_id);
                        $doc->exportField($this->nama_mitra);
                        $doc->exportField($this->jenis_mitra);
