...
class LanguagesAdd extends Languages
{
    ...
    // Page object name
    public string $PageObjName = "LanguagesAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "languagesadd";
...
// Get upload files
    ...
    {
        $this->Default->DefaultValue = $this->Default->getDefault(); // PHP
        $this->Default->OldValue = $this->Default->DefaultValue;
    }
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->Language_Code->CurrentValue != "") { // Check field with unique index
            $filter = "(`Language_Code` = '" . AdjustSql($this->Language_Code->CurrentValue) . "')";
        ...
        if ($insertRow && $this->ValidateKey && strval($newRow['Language_Code']) == "") {
    ...
    protected function getAddRow(): array
    {
        ...
        // Language_Code
        $this->Language_Code->setDbValueDef($newRow, $this->Language_Code->CurrentValue, false);

        // Language_Name
        $this->Language_Name->setDbValueDef($newRow, $this->Language_Name->CurrentValue, false);
        ...
        $this->Default->setDbValueDef($newRow, $tmpBool, strval($this->Default->CurrentValue) == "");

        // Site_Logo
        $this->Site_Logo->setDbValueDef($newRow, $this->Site_Logo->CurrentValue, false);

        // Site_Title
        $this->Site_Title->setDbValueDef($newRow, $this->Site_Title->CurrentValue, false);

        // Default_Thousands_Separator
        $this->Default_Thousands_Separator->setDbValueDef($newRow, $this->Default_Thousands_Separator->CurrentValue, false);

        // Default_Decimal_Point
        $this->Default_Decimal_Point->setDbValueDef($newRow, $this->Default_Decimal_Point->CurrentValue, false);

        // Default_Currency_Symbol
        $this->Default_Currency_Symbol->setDbValueDef($newRow, $this->Default_Currency_Symbol->CurrentValue, false);

        // Default_Money_Thousands_Separator
        $this->Default_Money_Thousands_Separator->setDbValueDef($newRow, $this->Default_Money_Thousands_Separator->CurrentValue, false);

        // Default_Money_Decimal_Point
        $this->Default_Money_Decimal_Point->setDbValueDef($newRow, $this->Default_Money_Decimal_Point->CurrentValue, false);

        // Terms_And_Condition_Text
        $this->Terms_And_Condition_Text->setDbValueDef($newRow, $this->Terms_And_Condition_Text->CurrentValue, false);

        // Announcement_Text
        $this->Announcement_Text->setDbValueDef($newRow, $this->Announcement_Text->CurrentValue, false);

        // About_Text
        $this->About_Text->setDbValueDef($newRow, $this->About_Text->CurrentValue, false);
        return $newRow;
    }
