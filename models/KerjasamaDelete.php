 ...
 * Page class
 */
class KerjasamaDelete extends Kerjasama
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KerjasamaDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "kerjasamadelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kerjasamalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("kerjasamalist"); // Return to list
                return;
            }
        }
