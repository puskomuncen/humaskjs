...
class MitraView extends Mitra
{
    ...
    // Page object name
    public string $PageObjName = "MitraView";
    ...
    // CSS class/style
    public string $CurrentPageName = "mitraview";
...
// Is modal
        ...
        if (($keyValue = Get("mitra_id") ?? Route("mitra_id")) !== null) {
            ...
            $this->RecKey["mitra_id"] = $this->mitra_id->QueryStringValue;
        } elseif (Post("mitra_id") !== null) {
            $this->mitra_id->setFormValue(Post("mitra_id"));
            $this->RecKey["mitra_id"] = $this->mitra_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->mitra_id->setQueryStringValue($keyValue);
            $this->RecKey["mitra_id"] = $this->mitra_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "mitralist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("mitralist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->mitra_id->CurrentValue, $this->CurrentRow['mitra_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "mitralist"; // No matching record, return to list
                    } else {
