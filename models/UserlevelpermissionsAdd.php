 ...
 * Page class
 */
class UserlevelpermissionsAdd extends Userlevelpermissions
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "UserlevelpermissionsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "userlevelpermissionsadd";
...
// Get upload files
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($insertRow && $this->ValidateKey && strval($newRow['UserLevelID']) == "") {
            $this->setFailureMessage($this->language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($newRow['TableName']) == "") {
            $this->setFailureMessage($this->language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }
    ...
    protected function getAddRow(): array
    {
        ...
        // UserLevelID
        $this->UserLevelID->setDbValueDef($newRow, $this->UserLevelID->CurrentValue, false);

        // TableName
        $this->_TableName->setDbValueDef($newRow, $this->_TableName->CurrentValue, false);

        // Permission
        $this->_Permission->setDbValueDef($newRow, $this->_Permission->CurrentValue, false);
        return $newRow;
    }
