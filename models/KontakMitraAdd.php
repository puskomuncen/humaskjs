 ...
 * Page class
 */
class KontakMitraAdd extends KontakMitra
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KontakMitraAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "kontakmitraadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "kontakmitraview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'kontak_id' first before field var 'x_kontak_id'
        $val = $this->hasFormValue("kontak_id") ? $this->getFormValue("kontak_id") : $this->getFormValue("x_kontak_id");
    }
    ...
    protected function getAddRow(): array
    {
        ...
        // nama_kontak
        $this->nama_kontak->setDbValueDef($newRow, $this->nama_kontak->CurrentValue, false);

        // jabatan
        $this->jabatan->setDbValueDef($newRow, $this->jabatan->CurrentValue, false);
