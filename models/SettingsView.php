...
class SettingsView extends Settings
{
    ...
    // Page object name
    public string $PageObjName = "SettingsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "settingsview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("Option_ID") ?? Route("Option_ID")) !== null) {
            $this->RecKey["Option_ID"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Option_ID") ?? Route("Option_ID")) !== null) {
            ...
            $returnUrl = "settingslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Option_ID->CurrentValue, $this->CurrentRow['Option_ID'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "settingslist"; // No matching record, return to list
                    } else {
...
/**
    ...
    {
        Language()->setPhrase("ViewCaption", "Here is the information ...");
    }
