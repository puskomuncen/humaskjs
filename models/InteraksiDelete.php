 ...
 * Page class
 */
class InteraksiDelete extends Interaksi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "InteraksiDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "interaksidelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("interaksilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("interaksilist"); // Return to list
                return;
            }
        }
