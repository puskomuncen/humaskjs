...
class HelpDelete extends Help
{
    ...
    // Page object name
    public string $PageObjName = "HelpDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "helpdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("helplist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("helplist"); // Return to list
                return;
            }
        }
