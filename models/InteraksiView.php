 ...
 * Page class
 */
class InteraksiView extends Interaksi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "InteraksiView";
    ...
    // CSS class/style
    public string $CurrentPageName = "interaksiview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("interaksi_id") ?? Route("interaksi_id")) !== null) {
            $this->RecKey["interaksi_id"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("interaksi_id") ?? Route("interaksi_id")) !== null) {
            ...
            $this->RecKey["interaksi_id"] = $this->interaksi_id->QueryStringValue;
        } elseif (Post("interaksi_id") !== null) {
            $this->interaksi_id->setFormValue(Post("interaksi_id"));
            $this->RecKey["interaksi_id"] = $this->interaksi_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->interaksi_id->setQueryStringValue($keyValue);
            $this->RecKey["interaksi_id"] = $this->interaksi_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "interaksilist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("interaksilist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->interaksi_id->CurrentValue, $this->CurrentRow['interaksi_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "interaksilist"; // No matching record, return to list
                    } else {
