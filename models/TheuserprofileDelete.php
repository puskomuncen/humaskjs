 ...
 * Page class
 */
class TheuserprofileDelete extends Theuserprofile
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TheuserprofileDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "theuserprofiledelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("theuserprofilelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        foreach ($rows as $row) {
            ...
            if (!$this->showOptionLink("delete")) {
                $userIdMsg = $this->language->phrase("NoDeletePermission");
        ...
        if (!$res) {
            $this->terminate("theuserprofilelist"); // Return to list
            return;
        }
