 ...
 * Page class
 */
class UserlevelpermissionsDelete extends Userlevelpermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "UserlevelpermissionsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "userlevelpermissionsdelete";
