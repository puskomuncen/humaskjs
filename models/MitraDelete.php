 ...
 * Page class
 */
class MitraDelete extends Mitra
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "MitraDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "mitradelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("mitralist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("mitralist"); // Return to list
                return;
            }
        }
