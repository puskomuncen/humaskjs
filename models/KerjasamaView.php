 ...
 * Page class
 */
class KerjasamaView extends Kerjasama
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KerjasamaView";
    ...
    // CSS class/style
    public string $CurrentPageName = "kerjasamaview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("kerjasama_id") ?? Route("kerjasama_id")) !== null) {
            $this->RecKey["kerjasama_id"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("kerjasama_id") ?? Route("kerjasama_id")) !== null) {
            ...
            $this->RecKey["kerjasama_id"] = $this->kerjasama_id->QueryStringValue;
        } elseif (Post("kerjasama_id") !== null) {
            $this->kerjasama_id->setFormValue(Post("kerjasama_id"));
            $this->RecKey["kerjasama_id"] = $this->kerjasama_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->kerjasama_id->setQueryStringValue($keyValue);
            $this->RecKey["kerjasama_id"] = $this->kerjasama_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "kerjasamalist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kerjasamalist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->kerjasama_id->CurrentValue, $this->CurrentRow['kerjasama_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kerjasamalist"; // No matching record, return to list
                    } else {
