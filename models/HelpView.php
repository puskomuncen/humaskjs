...
class HelpView extends Help
{
    ...
    // Page object name
    public string $PageObjName = "HelpView";
    ...
    // CSS class/style
    public string $CurrentPageName = "helpview";
...
// Is modal
        ...
        if (($keyValue = Get("Help_ID") ?? Route("Help_ID")) !== null) {
            ...
            $returnUrl = "helplist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Help_ID->CurrentValue, $this->CurrentRow['Help_ID'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "helplist"; // No matching record, return to list
                    } else {
