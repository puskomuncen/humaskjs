 ...
 * Page class
 */
class KerjasamaList extends Kerjasama
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KerjasamaList";
    ...
    public string $FormName = "fkerjasamalist";

    // CSS class/style
    public string $CurrentPageName = "kerjasamalist";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Initialize URLs
        $this->AddUrl = "kerjasamaadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "kerjasamadelete";
        $this->MultiUpdateUrl = "kerjasamaupdate";
...
// Is modal
		...
		if (ReadCookie('kerjasama_searchpanel') == 'notactive' || ReadCookie('kerjasama_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('kerjasama_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fkerjasamasrch");
        }
        $filterList = Concat($filterList, $this->kerjasama_id->AdvancedSearch->toJson(), ","); // Field kerjasama_id
        $filterList = Concat($filterList, $this->mitra_id->AdvancedSearch->toJson(), ","); // Field mitra_id
        $filterList = Concat($filterList, $this->judul_kerjasama->AdvancedSearch->toJson(), ","); // Field judul_kerjasama
        $filterList = Concat($filterList, $this->deskripsi->AdvancedSearch->toJson(), ","); // Field deskripsi
        $filterList = Concat($filterList, $this->tanggal_mulai->AdvancedSearch->toJson(), ","); // Field tanggal_mulai
        $filterList = Concat($filterList, $this->tanggal_berakhir->AdvancedSearch->toJson(), ","); // Field tanggal_berakhir
        $filterList = Concat($filterList, $this->jenis_kerjasama->AdvancedSearch->toJson(), ","); // Field jenis_kerjasama
        $filterList = Concat($filterList, $this->dokumen_path->AdvancedSearch->toJson(), ","); // Field dokumen_path
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fkerjasamasrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field kerjasama_id
        $this->kerjasama_id->AdvancedSearch->SearchValue = $filter["x_kerjasama_id"] ?? "";
        $this->kerjasama_id->AdvancedSearch->SearchOperator = $filter["z_kerjasama_id"] ?? "";
        $this->kerjasama_id->AdvancedSearch->SearchCondition = $filter["v_kerjasama_id"] ?? "";
        $this->kerjasama_id->AdvancedSearch->SearchValue2 = $filter["y_kerjasama_id"] ?? "";
        $this->kerjasama_id->AdvancedSearch->SearchOperator2 = $filter["w_kerjasama_id"] ?? "";
        $this->kerjasama_id->AdvancedSearch->save();

        // Field mitra_id
        $this->mitra_id->AdvancedSearch->SearchValue = $filter["x_mitra_id"] ?? "";
        $this->mitra_id->AdvancedSearch->SearchOperator = $filter["z_mitra_id"] ?? "";
        $this->mitra_id->AdvancedSearch->SearchCondition = $filter["v_mitra_id"] ?? "";
        $this->mitra_id->AdvancedSearch->SearchValue2 = $filter["y_mitra_id"] ?? "";
        $this->mitra_id->AdvancedSearch->SearchOperator2 = $filter["w_mitra_id"] ?? "";
        $this->mitra_id->AdvancedSearch->save();

        // Field judul_kerjasama
        $this->judul_kerjasama->AdvancedSearch->SearchValue = $filter["x_judul_kerjasama"] ?? "";
        $this->judul_kerjasama->AdvancedSearch->SearchOperator = $filter["z_judul_kerjasama"] ?? "";
        $this->judul_kerjasama->AdvancedSearch->SearchCondition = $filter["v_judul_kerjasama"] ?? "";
        $this->judul_kerjasama->AdvancedSearch->SearchValue2 = $filter["y_judul_kerjasama"] ?? "";
        $this->judul_kerjasama->AdvancedSearch->SearchOperator2 = $filter["w_judul_kerjasama"] ?? "";
        $this->judul_kerjasama->AdvancedSearch->save();
        ...
        // Field tanggal_mulai
        $this->tanggal_mulai->AdvancedSearch->SearchValue = $filter["x_tanggal_mulai"] ?? "";
        $this->tanggal_mulai->AdvancedSearch->SearchOperator = $filter["z_tanggal_mulai"] ?? "";
        $this->tanggal_mulai->AdvancedSearch->SearchCondition = $filter["v_tanggal_mulai"] ?? "";
        $this->tanggal_mulai->AdvancedSearch->SearchValue2 = $filter["y_tanggal_mulai"] ?? "";
        $this->tanggal_mulai->AdvancedSearch->SearchOperator2 = $filter["w_tanggal_mulai"] ?? "";
        $this->tanggal_mulai->AdvancedSearch->save();

        // Field tanggal_berakhir
        $this->tanggal_berakhir->AdvancedSearch->SearchValue = $filter["x_tanggal_berakhir"] ?? "";
        $this->tanggal_berakhir->AdvancedSearch->SearchOperator = $filter["z_tanggal_berakhir"] ?? "";
        $this->tanggal_berakhir->AdvancedSearch->SearchCondition = $filter["v_tanggal_berakhir"] ?? "";
        $this->tanggal_berakhir->AdvancedSearch->SearchValue2 = $filter["y_tanggal_berakhir"] ?? "";
        $this->tanggal_berakhir->AdvancedSearch->SearchOperator2 = $filter["w_tanggal_berakhir"] ?? "";
        $this->tanggal_berakhir->AdvancedSearch->save();

        // Field jenis_kerjasama
        $this->jenis_kerjasama->AdvancedSearch->SearchValue = $filter["x_jenis_kerjasama"] ?? "";
        $this->jenis_kerjasama->AdvancedSearch->SearchOperator = $filter["z_jenis_kerjasama"] ?? "";
        $this->jenis_kerjasama->AdvancedSearch->SearchCondition = $filter["v_jenis_kerjasama"] ?? "";
        $this->jenis_kerjasama->AdvancedSearch->SearchValue2 = $filter["y_jenis_kerjasama"] ?? "";
        $this->jenis_kerjasama->AdvancedSearch->SearchOperator2 = $filter["w_jenis_kerjasama"] ?? "";
        $this->jenis_kerjasama->AdvancedSearch->save();

        // Field dokumen_path
        $this->dokumen_path->AdvancedSearch->SearchValue = $filter["x_dokumen_path"] ?? "";
        $this->dokumen_path->AdvancedSearch->SearchOperator = $filter["z_dokumen_path"] ?? "";
        $this->dokumen_path->AdvancedSearch->SearchCondition = $filter["v_dokumen_path"] ?? "";
        $this->dokumen_path->AdvancedSearch->SearchValue2 = $filter["y_dokumen_path"] ?? "";
        $this->dokumen_path->AdvancedSearch->SearchOperator2 = $filter["w_dokumen_path"] ?? "";
        $this->dokumen_path->AdvancedSearch->save();
    ...
    public function basicSearchWhere(bool $default = false): string
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->judul_kerjasama;
        $searchFlds[] = &$this->deskripsi;
        $searchFlds[] = &$this->dokumen_path;
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->kerjasama_id); // kerjasama_id
            $this->updateSort($this->mitra_id); // mitra_id
            $this->updateSort($this->judul_kerjasama); // judul_kerjasama
            $this->updateSort($this->deskripsi); // deskripsi
            $this->updateSort($this->tanggal_mulai); // tanggal_mulai
            $this->updateSort($this->tanggal_berakhir); // tanggal_berakhir
            $this->updateSort($this->jenis_kerjasama); // jenis_kerjasama
            $this->updateSort($this->dokumen_path); // dokumen_path
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->kerjasama_id->setSort("");
                $this->mitra_id->setSort("");
                $this->judul_kerjasama->setSort("");
                $this->deskripsi->setSort("");
                $this->tanggal_mulai->setSort("");
                $this->tanggal_berakhir->setSort("");
                $this->jenis_kerjasama->setSort("");
                $this->dokumen_path->setSort("");
                $this->status->setSort("");
            }
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"kerjasama\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"kerjasama\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"kerjasama\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkerjasamalist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkerjasamalist\" data-key=\"" . $this->keyToJson(true) .
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->kerjasama_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"kerjasama\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "kerjasama_id");
            $this->createColumnOption($option, "mitra_id");
            $this->createColumnOption($option, "judul_kerjasama");
            $this->createColumnOption($option, "deskripsi");
            $this->createColumnOption($option, "tanggal_mulai");
            $this->createColumnOption($option, "tanggal_berakhir");
            $this->createColumnOption($option, "jenis_kerjasama");
            $this->createColumnOption($option, "dokumen_path");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fkerjasamasrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkerjasamasrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fkerjasamalist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_kerjasama", "data-rowtype" => RowType::ADD]);
...
// Load basic search values
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->kerjasama_id->TooltipValue = "";
            ...
            $this->judul_kerjasama->TooltipValue = "";
            ...
            $this->tanggal_mulai->TooltipValue = "";
            ...
            $this->jenis_kerjasama->TooltipValue = "";

            // dokumen_path
            $this->dokumen_path->HrefValue = "";
            $this->dokumen_path->TooltipValue = "";
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('kerjasama_searchpanel') == 'notactive' || ReadCookie('kerjasama_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkerjasamasrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('kerjasama_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkerjasamasrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkerjasamasrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
