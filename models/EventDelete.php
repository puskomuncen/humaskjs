...
class EventDelete extends Event
{
    ...
    // Page object name
    public string $PageObjName = "EventDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "eventdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("eventlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("eventlist"); // Return to list
                return;
            }
        }
