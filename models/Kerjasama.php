...
/**
 * Table class for kerjasama
 */
class Kerjasama extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $kerjasama_id;
    public DbField $mitra_id;
    public DbField $judul_kerjasama;
    public DbField $deskripsi;
    public DbField $tanggal_mulai;
    public DbField $tanggal_berakhir;
    public DbField $jenis_kerjasama;
    public DbField $dokumen_path;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "kerjasama"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // kerjasama_id
        $this->kerjasama_id = new DbField(
            $this, // Table
            'x_kerjasama_id', // Variable name
            'kerjasama_id', // Name
            '`kerjasama_id`', // Expression
            '`kerjasama_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`kerjasama_id`', // Virtual expression
            false, // Is virtual
        ...
        $this->kerjasama_id->InputTextType = "text";
        $this->kerjasama_id->Raw = true;
        $this->kerjasama_id->IsAutoIncrement = true; // Autoincrement field
        $this->kerjasama_id->IsPrimaryKey = true; // Primary key field
        $this->kerjasama_id->Nullable = false; // NOT NULL field
        $this->kerjasama_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->kerjasama_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['kerjasama_id'] = &$this->kerjasama_id;
        ...
        // judul_kerjasama
        $this->judul_kerjasama = new DbField(
            $this, // Table
            'x_judul_kerjasama', // Variable name
            'judul_kerjasama', // Name
            '`judul_kerjasama`', // Expression
            '`judul_kerjasama`', // Basic search expression
            200, // Type
            200, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`judul_kerjasama`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->judul_kerjasama->InputTextType = "text";
        $this->judul_kerjasama->Nullable = false; // NOT NULL field
        $this->judul_kerjasama->Required = true; // Required field
        $this->judul_kerjasama->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['judul_kerjasama'] = &$this->judul_kerjasama;

        // deskripsi
        $this->deskripsi = new DbField(
            $this, // Table
            'x_deskripsi', // Variable name
            'deskripsi', // Name
            '`deskripsi`', // Expression
            '`deskripsi`', // Basic search expression
            200, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`deskripsi`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->deskripsi->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['deskripsi'] = &$this->deskripsi;

        // tanggal_mulai
        $this->tanggal_mulai = new DbField(
            $this, // Table
            'x_tanggal_mulai', // Variable name
            'tanggal_mulai', // Name
            '`tanggal_mulai`', // Expression
            CastDateFieldForLike("`tanggal_mulai`", 0, "DB"), // Basic search expression
            133, // Type
            10, // Size
            0, // Date/Time format
            false, // Is upload field
            '`tanggal_mulai`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tanggal_mulai->InputTextType = "text";
        $this->tanggal_mulai->Raw = true;
        $this->tanggal_mulai->Nullable = false; // NOT NULL field
        $this->tanggal_mulai->Required = true; // Required field
        $this->tanggal_mulai->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
        $this->tanggal_mulai->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['tanggal_mulai'] = &$this->tanggal_mulai;

        // tanggal_berakhir
        $this->tanggal_berakhir = new DbField(
            $this, // Table
            'x_tanggal_berakhir', // Variable name
            'tanggal_berakhir', // Name
            '`tanggal_berakhir`', // Expression
            CastDateFieldForLike("`tanggal_berakhir`", 0, "DB"), // Basic search expression
            133, // Type
            10, // Size
            0, // Date/Time format
            false, // Is upload field
            '`tanggal_berakhir`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tanggal_berakhir->InputTextType = "text";
        $this->tanggal_berakhir->Raw = true;
        $this->tanggal_berakhir->Nullable = false; // NOT NULL field
        $this->tanggal_berakhir->Required = true; // Required field
        $this->tanggal_berakhir->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $this->language->phrase("IncorrectDate"));
        $this->tanggal_berakhir->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['tanggal_berakhir'] = &$this->tanggal_berakhir;

        // jenis_kerjasama
        $this->jenis_kerjasama = new DbField(
            $this, // Table
            'x_jenis_kerjasama', // Variable name
            'jenis_kerjasama', // Name
            '`jenis_kerjasama`', // Expression
            '`jenis_kerjasama`', // Basic search expression
            200, // Type
            6, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`jenis_kerjasama`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->jenis_kerjasama->InputTextType = "text";
        $this->jenis_kerjasama->Raw = true;
        $this->jenis_kerjasama->Nullable = false; // NOT NULL field
        $this->jenis_kerjasama->Required = true; // Required field
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->jenis_kerjasama->Lookup = new Lookup($this->jenis_kerjasama, 'kerjasama', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->jenis_kerjasama->Lookup = new Lookup($this->jenis_kerjasama, 'kerjasama', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
        ...
        $this->jenis_kerjasama->OptionCount = 3;
        $this->jenis_kerjasama->SearchOperators = ["=", "<>"];
        $this->Fields['jenis_kerjasama'] = &$this->jenis_kerjasama;

        // dokumen_path
        $this->dokumen_path = new DbField(
            $this, // Table
            'x_dokumen_path', // Variable name
            'dokumen_path', // Name
            '`dokumen_path`', // Expression
            '`dokumen_path`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`dokumen_path`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->dokumen_path->InputTextType = "text";
        $this->dokumen_path->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['dokumen_path'] = &$this->dokumen_path;
        ...
        $this->status->addMethod("getDefault", fn() => "Aktif");
        $this->status->InputTextType = "text";
        $this->status->Raw = true;
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status->Lookup = new Lookup($this->status, 'kerjasama', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->status->Lookup = new Lookup($this->status, 'kerjasama', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "kerjasama";
    }
    ...
    public function insert(array &$row): int|bool
    {
        ...
        if ($result) {
            $this->kerjasama_id->setDbValue($conn->lastInsertId());
            $row['kerjasama_id'] = $this->kerjasama_id->DbValue;
        }
        return $result;
    }
    ...
    public function update(array $row, string|array $where = "", ?array $old = null, bool $currentFilter = true): int|bool
    {
        ...
        if ($success) {
            if (!isset($row['kerjasama_id']) && !IsEmpty($this->kerjasama_id->CurrentValue)) {
                $row['kerjasama_id'] = $this->kerjasama_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(?array $row, string|array $where = ""): QueryBuilder
    {
        ...
        $where = is_array($where) ? $this->arrayToFilter($where) : $where;
        if ($row) {
            if (array_key_exists('kerjasama_id', $row)) {
                AddFilter($where, QuotedName('kerjasama_id', $this->Dbid) . '=' . QuotedValue($row['kerjasama_id'], $this->kerjasama_id->DataType, $this->Dbid));
            }
        }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->kerjasama_id->DbValue = $row['kerjasama_id'];
        $this->mitra_id->DbValue = $row['mitra_id'];
        $this->judul_kerjasama->DbValue = $row['judul_kerjasama'];
        $this->deskripsi->DbValue = $row['deskripsi'];
        $this->tanggal_mulai->DbValue = $row['tanggal_mulai'];
        $this->tanggal_berakhir->DbValue = $row['tanggal_berakhir'];
        $this->jenis_kerjasama->DbValue = $row['jenis_kerjasama'];
        $this->dokumen_path->DbValue = $row['dokumen_path'];
    ...
    {
        return "`kerjasama_id` = @kerjasama_id@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->kerjasama_id->CurrentValue : $this->kerjasama_id->OldValue;
        if (IsEmpty($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey(string $key, bool $current = false, ?string $keySeparator = null): void
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->kerjasama_id->CurrentValue = $keys[0];
            } else {
                $this->kerjasama_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter(?array $row = null, bool $current = false): string
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('kerjasama_id', $row) ? $row['kerjasama_id'] : null;
        } else {
            $val = !IsEmpty($this->kerjasama_id->OldValue) && !$current ? $this->kerjasama_id->OldValue : $this->kerjasama_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@kerjasama_id@", AdjustSql($val), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("kerjasamalist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "kerjasamaview" => $this->language->phrase("View"),
            "kerjasamaedit" => $this->language->phrase("Edit"),
            "kerjasamaadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "KerjasamaView",
            Config("API_ADD_ACTION") => "KerjasamaAdd",
            Config("API_EDIT_ACTION") => "KerjasamaEdit",
            Config("API_DELETE_ACTION") => "KerjasamaDelete",
            Config("API_LIST_ACTION") => "KerjasamaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("kerjasamaview", $parm);
        } else {
            $url = $this->keyUrl("kerjasamaview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kerjasamaedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kerjasamalist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kerjasamaadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kerjasamalist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("kerjasamadelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"kerjasama_id\":" . VarToJson($this->kerjasama_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->kerjasama_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->kerjasama_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys(): array
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("kerjasama_id") ?? Route("kerjasama_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys(bool $setCurrent = true): string
    {
        ...
        foreach ($arKeys as $key) {
            if ($setCurrent) {
                $this->kerjasama_id->CurrentValue = $key;
            } else {
                $this->kerjasama_id->OldValue = $key;
            }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->kerjasama_id);
                    $doc->exportCaption($this->mitra_id);
                    $doc->exportCaption($this->judul_kerjasama);
                    $doc->exportCaption($this->deskripsi);
                    $doc->exportCaption($this->tanggal_mulai);
                    $doc->exportCaption($this->tanggal_berakhir);
                    $doc->exportCaption($this->jenis_kerjasama);
                    $doc->exportCaption($this->dokumen_path);
        ...
        while (($row = $result->fetchAssociative()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->kerjasama_id);
                        $doc->exportField($this->mitra_id);
                        $doc->exportField($this->judul_kerjasama);
                        $doc->exportField($this->deskripsi);
                        $doc->exportField($this->tanggal_mulai);
                        $doc->exportField($this->tanggal_berakhir);
                        $doc->exportField($this->jenis_kerjasama);
                        $doc->exportField($this->dokumen_path);
