 ...
 * Page class
 */
class LanguagesDelete extends Languages
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "LanguagesDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "languagesdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("languageslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("languageslist"); // Return to list
                return;
            }
        }
