 ...
 * Page class
 */
class UserlevelpermissionsView extends Userlevelpermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "UserlevelpermissionsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "userlevelpermissionsview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("UserLevelID") ?? Route("UserLevelID")) !== null) {
            $this->RecKey["UserLevelID"] = $keyValue;
        }
        if (($keyValue = Get("_TableName") ?? Route("_TableName")) !== null) {
            $this->RecKey["_TableName"] = $keyValue;
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("userlevelpermissionslist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->UserLevelID->CurrentValue, $this->CurrentRow['UserLevelID']) && SameString($this->_TableName->CurrentValue, $this->CurrentRow['TableName'])) {
