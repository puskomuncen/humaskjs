 ...
 * Page class
 */
class TheuserprofileAdd extends Theuserprofile
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "TheuserprofileAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "theuserprofileadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "theuserprofileview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->getFormValue("Profile", null) ?? $this->getFormValue("x__Profile", null);
    ...
    protected function validateForm(): bool
    {
        ...
        $validateForm = true;
            ...
            if ($this->_Profile->Visible && $this->_Profile->Required) {
                if (!$this->_Profile->IsDetailKey && IsEmpty($this->_Profile->FormValue)) {
    ...
    protected function getAddRow(): array
    {
        ...
        // Profile
        $this->_Profile->setDbValueDef($newRow, $this->_Profile->CurrentValue, false);
