 ...
 * Page class
 */
class InteraksiAdd extends Interaksi
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "InteraksiAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "interaksiadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "interaksiview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'interaksi_id' first before field var 'x_interaksi_id'
        $val = $this->hasFormValue("interaksi_id") ? $this->getFormValue("interaksi_id") : $this->getFormValue("x_interaksi_id");
    }
    ...
    protected function getAddRow(): array
    {
        ...
        // jenis_interaksi
        $this->jenis_interaksi->setDbValueDef($newRow, $this->jenis_interaksi->CurrentValue, false);

        // catatan
        $this->catatan->setDbValueDef($newRow, $this->catatan->CurrentValue, false);

        // tanggal_interaksi
        $this->tanggal_interaksi->setDbValueDef($newRow, UnFormatDateTime($this->tanggal_interaksi->CurrentValue, $this->tanggal_interaksi->formatPattern()), false);
        return $newRow;
    }
