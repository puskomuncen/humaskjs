 ...
 * Page class
 */
class AnnouncementView extends Announcement
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "AnnouncementView";
    ...
    // CSS class/style
    public string $CurrentPageName = "announcementview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("Announcement_ID") ?? Route("Announcement_ID")) !== null) {
            $this->RecKey["Announcement_ID"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Announcement_ID") ?? Route("Announcement_ID")) !== null) {
            ...
            $this->RecKey["Announcement_ID"] = $this->Announcement_ID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Announcement_ID->setQueryStringValue($keyValue);
            $this->RecKey["Announcement_ID"] = $this->Announcement_ID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "announcementlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Announcement_ID->CurrentValue, $this->CurrentRow['Announcement_ID'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "announcementlist"; // No matching record, return to list
                    } else {
