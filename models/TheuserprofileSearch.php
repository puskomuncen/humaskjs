 ...
 * Page class
 */
class TheuserprofileSearch extends Theuserprofile
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "TheuserprofileSearch";
    ...
    // CSS class/style
    public string $CurrentPageName = "theuserprofilesearch";
...
// Is modal
        ...
        if ($this->isSearch()) {
            ...
            if ($srchStr != "") {
                $srchStr = "theuserprofilelist" . "?" . $srchStr;
