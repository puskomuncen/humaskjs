...
/**
 * Table class for theuserprofile
 */
class Theuserprofile extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "theuserprofile"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Gender->Lookup = new Lookup($this->Gender, 'theuserprofile', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->Gender->Lookup = new Lookup($this->Gender, 'theuserprofile', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Activated->Lookup = new Lookup($this->Activated, 'theuserprofile', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->Activated->Lookup = new Lookup($this->Activated, 'theuserprofile', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->ActiveStatus->Lookup = new Lookup($this->ActiveStatus, 'theuserprofile', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->ActiveStatus->Lookup = new Lookup($this->ActiveStatus, 'theuserprofile', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "theuserprofile";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("theuserprofilelist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "theuserprofileview" => $this->language->phrase("View"),
            "theuserprofileedit" => $this->language->phrase("Edit"),
            "theuserprofileadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TheuserprofileView",
            Config("API_ADD_ACTION") => "TheuserprofileAdd",
            Config("API_EDIT_ACTION") => "TheuserprofileEdit",
            Config("API_DELETE_ACTION") => "TheuserprofileDelete",
            Config("API_LIST_ACTION") => "TheuserprofileList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("theuserprofileview", $parm);
        } else {
            $url = $this->keyUrl("theuserprofileview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "theuserprofileadd?" . $parm;
        } else {
            $url = "theuserprofileadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("theuserprofileedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("theuserprofilelist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("theuserprofileadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("theuserprofilelist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("theuserprofiledelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->Photo->UseColorbox) {
            ...
            $this->Photo->LinkAttrs["data-rel"] = "theuserprofile_x_Photo";
        ...
        if ($this->Avatar->UseColorbox) {
            ...
            $this->Avatar->LinkAttrs["data-rel"] = "theuserprofile_x_Avatar";
    ...
    {
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM theuserprofile";
