 ...
 * Page class
 */
class PublikasiDelete extends Publikasi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PublikasiDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "publikasidelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("publikasilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("publikasilist"); // Return to list
                return;
            }
        }
