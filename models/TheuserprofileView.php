 ...
 * Page class
 */
class TheuserprofileView extends Theuserprofile
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TheuserprofileView";
    ...
    // CSS class/style
    public string $CurrentPageName = "theuserprofileview";
...
// Is modal
        ...
        if (($keyValue = Get("_UserID") ?? Route("_UserID")) !== null) {
            ...
            $returnUrl = "theuserprofilelist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "theuserprofilelist"; // No matching record, return to list
                    } else {
