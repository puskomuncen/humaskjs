 ...
 * Page class
 */
class KontakMitraDelete extends KontakMitra
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KontakMitraDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "kontakmitradelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kontakmitralist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("kontakmitralist"); // Return to list
                return;
            }
        }
