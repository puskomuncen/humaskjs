...
class EventView extends Event
{
    ...
    // Page object name
    public string $PageObjName = "EventView";
    ...
    // CSS class/style
    public string $CurrentPageName = "eventview";
...
// Is modal
        ...
        if (($keyValue = Get("event_id") ?? Route("event_id")) !== null) {
            ...
            $this->RecKey["event_id"] = $this->event_id->QueryStringValue;
        } elseif (Post("event_id") !== null) {
            $this->event_id->setFormValue(Post("event_id"));
            $this->RecKey["event_id"] = $this->event_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->event_id->setQueryStringValue($keyValue);
            $this->RecKey["event_id"] = $this->event_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "eventlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("eventlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->event_id->CurrentValue, $this->CurrentRow['event_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "eventlist"; // No matching record, return to list
                    } else {
