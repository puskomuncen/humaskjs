 ...
 * Page class
 */
class KerjasamaAdd extends Kerjasama
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KerjasamaAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "kerjasamaadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "kerjasamaview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'kerjasama_id' first before field var 'x_kerjasama_id'
        $val = $this->hasFormValue("kerjasama_id") ? $this->getFormValue("kerjasama_id") : $this->getFormValue("x_kerjasama_id");
    }
    ...
    protected function getAddRow(): array
    {
        ...
        // judul_kerjasama
        $this->judul_kerjasama->setDbValueDef($newRow, $this->judul_kerjasama->CurrentValue, false);
        ...
        // tanggal_berakhir
        $this->tanggal_berakhir->setDbValueDef($newRow, UnFormatDateTime($this->tanggal_berakhir->CurrentValue, $this->tanggal_berakhir->formatPattern()), false);

        // jenis_kerjasama
        $this->jenis_kerjasama->setDbValueDef($newRow, $this->jenis_kerjasama->CurrentValue, false);

        // dokumen_path
        $this->dokumen_path->setDbValueDef($newRow, $this->dokumen_path->CurrentValue, false);
