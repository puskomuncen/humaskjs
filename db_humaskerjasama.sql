...
CREATE TABLE `interaksi` (
  `interaksi_id` int(11) NOT NULL,
  `mitra_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `jenis_interaksi` enum('Meeting','Telepon','Email','Event') NOT NULL,
  `catatan` text DEFAULT NULL,
  `tanggal_interaksi` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `kerjasama` (
  ...
  `jenis_kerjasama` enum('MoU','MoA','Proyek') NOT NULL,
  `dokumen_path` varchar(255) DEFAULT NULL,
  `status` enum('Aktif','Kadaluarsa','Dalam Perpanjangan') DEFAULT 'Aktif'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `kontak_mitra`
--

CREATE TABLE `kontak_mitra` (
...
('id-ID', 'Indonesia', 'N', '-', 'PHPMaker Proyek Demo', '.', ',', 'Rp', '.', ',', 'Dengan menggunakan Aplikasi Web <strong>One Time Password (OTP)</strong>, maka Anda wajib mematuhi <strong>Syarat dan Ketentuan</strong> yang kami tetapkan.<br><br>1. Aplikasi OTP berfungsi untuk mereset Kata Sandi (Password) pengguna aplikasi bisnis Pos Indonesia.<br><br>2. Aplikasi yang menggunakan OTP untuk mereset Kata Sandi penggunanya adalah System Online Payment Point (SOPP) dan Remittance Service (RS).<br><br>3. Pengguna aplikasi bisnis yang didaftarkan di Aplikasi OTP hanya mereka yang memiliki level Manajer Pelayanan dan Manajer PPLA (Pengawas Pelayanan Luar dan Agenpos)<br><br>4. Pengguna Aplikasi OTP yang ingin mendaftarkan akunnya harus sudah terdaftar sebelumnya di aplikasi bisnis yang bertalian.<br><br>5. Pengguna aplikasi bisnis yang akan menerima Password baru dari Aplikasi OTP sudah memiliki Handphone dan Email.<br><br>6. Setiap Pengguna aplikasi bisnis tidak boleh menggunakan Email dan Nomor Handphone yang sama dengan yang digunakan oleh pengguna lainnya.<br><br>7. Pengguna aplikasi bisnis yang melakukan reset Password melalui Aplikasi OTP hanya mereka yang memiliki level Manajer Pelayanan dan Manajer PPLA.<br><br>8. Setiap hari, Pengguna Aplikasi OTP wajib mereset Password milik staff yang berada di bawah pengawasannya.<br><br>9. Password baru hasil reset dari Aplikasi OTP akan dikirimkan ke Email dan atau Handphone milik pengguna aplikasi bisnis masing-masing.<br><br>10. Dilarang memberitahukan data akun (Username/ID Petugas dan atau Password) kepada pihak lain manapun, baik secara sengaja maupun tidak sengaja.<br><br>11. Baik Pengguna Aplikasi OTP maupun pengguna aplikasi bisnis harus sungguh-sungguh bertanggung jawab melindungi data akunnya.<br><br>12. Kelalaian dalam menyimpan data akun sehingga bisa diketahui oleh pihak lain menjadi tanggung jawab masing-masing.<br><br>', 'Ini teks pengumuman dari database. Anda dapat mengubah teks ini dari tabel languages ...', '<span class=\'dialogtitle\' style=\'white-space: nowrap;\'>Judul Aplikasi Anda di sini, versi 1.0</span><br><br>Deskripsi aplikasi baris pertama Anda di sini ... <br><br>Deskripsi aplikasi baris kedua Anda di sini ... <br><br><br>Web Developer:<br></span>Masino Sinaga (masino.sinaga@gmail.com)<br>Anda dapat mengubah teks ini dari tabel languages,<br>... <br>... <br>'),
('ar-IQ', 'Arabic', 'N', '-', 'PHPMaker Demo Project', ',', '.', '$', ',', '.', 'تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول <br><br>تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول <br><br>تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول <br><br>تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول تسجيل الدخول', 'This is the announcement text from database. You can edit this text from the languages table ...', '<span class=\'dialogtitle\' style=\'white-space: nowrap;\'>Your Application Title goes here, version 1.0</span><br><br>Your application description line one goes here ... <br><br>Your application description line two goes here ... <br><br><br>Web Developer:<br></span>Masino Sinaga (masino.sinaga@gmail.com)<br>You can edit this text from the languages table,<br>... <br>... <br>');
...
CREATE TABLE `mitra` (
  ...
  `jenis_mitra` enum('Perusahaan','Pemerintah','Universitas','NGO') NOT NULL,
...
INSERT INTO `mitra` (`mitra_id`, `nama_mitra`, `jenis_mitra`, `alamat`, `email`, `telepon`, `tanggal_bergabung`, `status_aktif`) VALUES
(1, 'PT ASDY', 'Perusahaan', 'fdsf', 'somarury@gmail.com', '065646', '2025-06-02', 1);
...
CREATE TABLE `publikasi` (
  ...
  `jenis_media` enum('Website','Sosial Media','Press Release') NOT NULL,
...
ALTER TABLE `interaksi`
  ...
  ADD KEY `idx_interaksi_tanggal` (`tanggal_interaksi`);

--
-- Indexes for table `kerjasama`
--
ALTER TABLE `kerjasama`
  ADD PRIMARY KEY (`kerjasama_id`),
  ADD KEY `idx_kerjasama_status` (`status`),
  ADD KEY `idx_kerjasama_mitra` (`mitra_id`);

--
-- Indexes for table `kontak_mitra`
--
ALTER TABLE `kontak_mitra`
...
--
ALTER TABLE `interaksi`
  MODIFY `interaksi_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kerjasama`
--
ALTER TABLE `kerjasama`
  MODIFY `kerjasama_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kontak_mitra`
--
ALTER TABLE `kontak_mitra`
...
--
ALTER TABLE `mitra`
  MODIFY `mitra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `event`
  ADD CONSTRAINT `event_ibfk_1` FOREIGN KEY (`mitra_id`) REFERENCES `mitra` (`mitra_id`);

--
-- Constraints for table `interaksi`
--
ALTER TABLE `interaksi`
  ADD CONSTRAINT `interaksi_ibfk_1` FOREIGN KEY (`mitra_id`) REFERENCES `mitra` (`mitra_id`);

--
-- Constraints for table `kerjasama`
--
ALTER TABLE `kerjasama`
  ADD CONSTRAINT `kerjasama_ibfk_1` FOREIGN KEY (`mitra_id`) REFERENCES `mitra` (`mitra_id`);

--
-- Constraints for table `kontak_mitra`
--
ALTER TABLE `kontak_mitra`
  ADD CONSTRAINT `kontak_mitra_ibfk_1` FOREIGN KEY (`mitra_id`) REFERENCES `mitra` (`mitra_id`) ON DELETE CASCADE;
COMMIT;
