...
return [
    ...
    "event" => \DI\autowire(Event::class),
    "interaksi" => \DI\autowire(Interaksi::class),
    "kerjasama" => \DI\autowire(Kerjasama::class),
    "kontak_mitra" => \DI\autowire(KontakMitra::class),
    "mitra" => \DI\autowire(Mitra::class),
    "publikasi" => \DI\autowire(Publikasi::class),
