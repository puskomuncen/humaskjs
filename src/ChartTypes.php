...
class ChartTypes
{
     ...
     * @var int
     */
    public static int $DefaultType = 1001; // Default
     ...
     */
    public static function getName(int $id, bool $scroll = false): string
    {
    ...
    {
        return Config("DEFAULT_CHART_RENDERER") ?: ChartJsRenderer::class;
    }
}
