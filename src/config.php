...
$CONFIG = [
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-orange elevation-4", // CSS class(es) for sidebar
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-orange navbar-light border-bottom-0", // CSS class(es) for navbar
