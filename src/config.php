...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/humaskerjasama.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-lightblue elevation-4", // CSS class(es) for sidebar
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-lightblue navbar-dark border-bottom-0", // CSS class(es) for navbar
    ...
    // Export Log
    "EXPORT_PATH" => "export-48315587-314b-49e3-9526-bfd08eac1cb1", // Export folder
