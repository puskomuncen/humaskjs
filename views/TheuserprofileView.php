...
<form name="ftheuserprofileview" id="ftheuserprofileview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script<?= Nonce() ?>>
...
<?php if ($Page->_UserID->Visible) { // UserID ?>
    <tr id="r__UserID"<?= $Page->_UserID->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile__UserID"><?= $Page->_UserID->caption() ?></span></td>
...
<?php if ($Page->_Username->Visible) { // Username ?>
    <tr id="r__Username"<?= $Page->_Username->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile__Username"><?= $Page->_Username->caption() ?></span></td>
...
<?php if ($Page->UserLevel->Visible) { // UserLevel ?>
    <tr id="r_UserLevel"<?= $Page->UserLevel->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_UserLevel"><?= $Page->UserLevel->caption() ?></span></td>
...
<?php if ($Page->FirstName->Visible) { // FirstName ?>
    <tr id="r_FirstName"<?= $Page->FirstName->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_FirstName"><?= $Page->FirstName->caption() ?></span></td>
...
<?php if ($Page->LastName->Visible) { // LastName ?>
    <tr id="r_LastName"<?= $Page->LastName->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_LastName"><?= $Page->LastName->caption() ?></span></td>
...
<?php if ($Page->CompleteName->Visible) { // CompleteName ?>
    <tr id="r_CompleteName"<?= $Page->CompleteName->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_CompleteName"><?= $Page->CompleteName->caption() ?></span></td>
...
<?php if ($Page->BirthDate->Visible) { // BirthDate ?>
    <tr id="r_BirthDate"<?= $Page->BirthDate->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_BirthDate"><?= $Page->BirthDate->caption() ?></span></td>
...
<?php if ($Page->HomePhone->Visible) { // HomePhone ?>
    <tr id="r_HomePhone"<?= $Page->HomePhone->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_HomePhone"><?= $Page->HomePhone->caption() ?></span></td>
...
<?php if ($Page->Photo->Visible) { // Photo ?>
    <tr id="r_Photo"<?= $Page->Photo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_Photo"><?= $Page->Photo->caption() ?></span></td>
...
<?php if ($Page->Notes->Visible) { // Notes ?>
    <tr id="r_Notes"<?= $Page->Notes->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_Notes"><?= $Page->Notes->caption() ?></span></td>
...
<?php if ($Page->ReportsTo->Visible) { // ReportsTo ?>
    <tr id="r_ReportsTo"<?= $Page->ReportsTo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_ReportsTo"><?= $Page->ReportsTo->caption() ?></span></td>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <tr id="r_Gender"<?= $Page->Gender->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_Gender"><?= $Page->Gender->caption() ?></span></td>
...
<?php if ($Page->_Email->Visible) { // Email ?>
    <tr id="r__Email"<?= $Page->_Email->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile__Email"><?= $Page->_Email->caption() ?></span></td>
...
<?php if ($Page->Activated->Visible) { // Activated ?>
    <tr id="r_Activated"<?= $Page->Activated->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_Activated"><?= $Page->Activated->caption() ?></span></td>
...
<?php if ($Page->Avatar->Visible) { // Avatar ?>
    <tr id="r_Avatar"<?= $Page->Avatar->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_Avatar"><?= $Page->Avatar->caption() ?></span></td>
...
<?php if ($Page->ActiveStatus->Visible) { // ActiveStatus ?>
    <tr id="r_ActiveStatus"<?= $Page->ActiveStatus->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_ActiveStatus"><?= $Page->ActiveStatus->caption() ?></span></td>
...
<?php if ($Page->MessengerColor->Visible) { // MessengerColor ?>
    <tr id="r_MessengerColor"<?= $Page->MessengerColor->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_MessengerColor"><?= $Page->MessengerColor->caption() ?></span></td>
...
<?php if ($Page->CreatedAt->Visible) { // CreatedAt ?>
    <tr id="r_CreatedAt"<?= $Page->CreatedAt->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_CreatedAt"><?= $Page->CreatedAt->caption() ?></span></td>
...
<?php if ($Page->CreatedBy->Visible) { // CreatedBy ?>
    <tr id="r_CreatedBy"<?= $Page->CreatedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_CreatedBy"><?= $Page->CreatedBy->caption() ?></span></td>
...
<?php if ($Page->UpdatedAt->Visible) { // UpdatedAt ?>
    <tr id="r_UpdatedAt"<?= $Page->UpdatedAt->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_UpdatedAt"><?= $Page->UpdatedAt->caption() ?></span></td>
        <td data-name="UpdatedAt"<?= $Page->UpdatedAt->cellAttributes() ?>>
<span id="el_theuserprofile_UpdatedAt">
...
<?php if ($Page->UpdatedBy->Visible) { // UpdatedBy ?>
    <tr id="r_UpdatedBy"<?= $Page->UpdatedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_theuserprofile_UpdatedBy"><?= $Page->UpdatedBy->caption() ?></span></td>
        <td data-name="UpdatedBy"<?= $Page->UpdatedBy->cellAttributes() ?>>
<span id="el_theuserprofile_UpdatedBy">
