...
var currentForm;
var ftheuserprofilesearch, currentSearchForm, currentAdvancedSearchForm;
...
<form name="ftheuserprofilesearch" id="ftheuserprofilesearch" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->_UserID->Visible) { // UserID ?>
    <div id="r__UserID" class="row"<?= $Page->_UserID->rowAttributes() ?>>
        <label for="x__UserID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile__UserID"><?= $Page->_UserID->caption() ?></span>
...
<input type="hidden" name="z__UserID" id="z__UserID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->_UserID->cellAttributes() ?>>
                ...
                <span id="el_theuserprofile__UserID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->_UserID->getInputTextType() ?>" name="x__UserID" id="x__UserID" data-table="theuserprofile" data-field="x__UserID" value="<?= $Page->_UserID->getEditValue() ?>" placeholder="<?= HtmlEncode($Page->_UserID->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->_UserID->formatPattern()) ?>"<?= $Page->_UserID->editAttributes() ?>>
...
<?php if ($Page->_Username->Visible) { // Username ?>
    <div id="r__Username" class="row"<?= $Page->_Username->rowAttributes() ?>>
        <label for="x__Username" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile__Username"><?= $Page->_Username->caption() ?></span>
        <span class="ew-search-operator">
...
<input type="hidden" name="z__Username" id="z__Username" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->_Username->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile__Username" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->UserLevel->Visible) { // UserLevel ?>
    <div id="r_UserLevel" class="row"<?= $Page->UserLevel->rowAttributes() ?>>
        <label for="x_UserLevel" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_UserLevel"><?= $Page->UserLevel->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_UserLevel" id="z_UserLevel" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->UserLevel->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_UserLevel" class="ew-search-field ew-search-field-single">
    <select
        id="x_UserLevel"
        name="x_UserLevel"
        class="form-select ew-select<?= $Page->UserLevel->isInvalidClass() ?>"
        <?php if (!$Page->UserLevel->IsNativeSelect) { ?>
        data-select2-id="ftheuserprofilesearch_x_UserLevel"
        <?php } ?>
...
<?php if (!$Page->UserLevel->IsNativeSelect) { ?>
<script<?= Nonce() ?>>
loadjs.ready("ftheuserprofilesearch", function() {
    var options = { name: "x_UserLevel", selectId: "ftheuserprofilesearch_x_UserLevel" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftheuserprofilesearch.lists.UserLevel?.lookupOptions.length) {
        options.data = { id: "x_UserLevel", form: "ftheuserprofilesearch" };
    } else {
        options.ajax = { id: "x_UserLevel", form: "ftheuserprofilesearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php if ($Page->FirstName->Visible) { // FirstName ?>
    <div id="r_FirstName" class="row"<?= $Page->FirstName->rowAttributes() ?>>
        <label for="x_FirstName" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_FirstName"><?= $Page->FirstName->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_FirstName" id="z_FirstName" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->FirstName->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_FirstName" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->LastName->Visible) { // LastName ?>
    <div id="r_LastName" class="row"<?= $Page->LastName->rowAttributes() ?>>
        <label for="x_LastName" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_LastName"><?= $Page->LastName->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LastName" id="z_LastName" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->LastName->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_LastName" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->CompleteName->Visible) { // CompleteName ?>
    <div id="r_CompleteName" class="row"<?= $Page->CompleteName->rowAttributes() ?>>
        <label for="x_CompleteName" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_CompleteName"><?= $Page->CompleteName->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_CompleteName" id="z_CompleteName" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->CompleteName->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_CompleteName" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->BirthDate->Visible) { // BirthDate ?>
    <div id="r_BirthDate" class="row"<?= $Page->BirthDate->rowAttributes() ?>>
        <label for="x_BirthDate" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_BirthDate"><?= $Page->BirthDate->caption() ?></span>
        <span class="ew-search-operator">
...
<input type="hidden" name="z_BirthDate" id="z_BirthDate" value="BETWEEN">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->BirthDate->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_BirthDate" class="ew-search-field">
...
<script<?= Nonce() ?>>
loadjs.ready(["ftheuserprofilesearch", "datetimepicker"], function () {
...
<?php } ?>
<script<?= Nonce() ?>>
loadjs.ready(['ftheuserprofilesearch', 'jqueryinputmask'], function() {
	options = {
		'jitMasking': false,
		'removeMaskOnSubmit': true
	};
	ew.createjQueryInputMask("ftheuserprofilesearch", "x_BirthDate", jQuery.extend(true, "", options));
});
</script>
</span>
                    <span class="ew-search-and"><label><?= $Language->phrase("AND") ?></label></span>
                    <span id="el2_theuserprofile_BirthDate" class="ew-search-field2">
<input type="<?= $Page->BirthDate->getInputTextType() ?>" name="y_BirthDate" id="y_BirthDate" data-table="theuserprofile" data-field="x_BirthDate" value="<?= $Page->BirthDate->EditValue2 ?>" size="12" maxlength="10" placeholder="<?= HtmlEncode($Page->BirthDate->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->BirthDate->formatPattern()) ?>"<?= $Page->BirthDate->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->BirthDate->getErrorMessage(false) ?></div>
<?php if (!$Page->BirthDate->ReadOnly && !$Page->BirthDate->Disabled && !isset($Page->BirthDate->EditAttrs["readonly"]) && !isset($Page->BirthDate->EditAttrs["disabled"])) { ?>
<script<?= Nonce() ?>>
loadjs.ready(["ftheuserprofilesearch", "datetimepicker"], function () {
...
loadjs.ready(['ftheuserprofilesearch', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftheuserprofilesearch", "y_BirthDate", jQuery.extend(true, "", options));
});
</script>
</span>
                </div>
...
<?php if ($Page->HomePhone->Visible) { // HomePhone ?>
    <div id="r_HomePhone" class="row"<?= $Page->HomePhone->rowAttributes() ?>>
        <label for="x_HomePhone" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_HomePhone"><?= $Page->HomePhone->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_HomePhone" id="z_HomePhone" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->HomePhone->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_HomePhone" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->Photo->Visible) { // Photo ?>
    <div id="r_Photo" class="row"<?= $Page->Photo->rowAttributes() ?>>
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_Photo"><?= $Page->Photo->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Photo" id="z_Photo" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Photo->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_Photo" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Photo->getInputTextType() ?>" name="x_Photo" id="x_Photo" data-table="theuserprofile" data-field="x_Photo" value="<?= $Page->Photo->getEditValue() ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Photo->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Photo->formatPattern()) ?>"<?= $Page->Photo->editAttributes() ?>>
...
<?php if ($Page->Notes->Visible) { // Notes ?>
    <div id="r_Notes" class="row"<?= $Page->Notes->rowAttributes() ?>>
        <label for="x_Notes" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_Notes"><?= $Page->Notes->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Notes" id="z_Notes" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Notes->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_Notes" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Notes->getInputTextType() ?>" name="x_Notes" id="x_Notes" data-table="theuserprofile" data-field="x_Notes" value="<?= $Page->Notes->getEditValue() ?>" size="50" placeholder="<?= HtmlEncode($Page->Notes->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Notes->formatPattern()) ?>"<?= $Page->Notes->editAttributes() ?>>
...
<?php if ($Page->ReportsTo->Visible) { // ReportsTo ?>
    <div id="r_ReportsTo" class="row"<?= $Page->ReportsTo->rowAttributes() ?>>
        <label for="x_ReportsTo" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_ReportsTo"><?= $Page->ReportsTo->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_ReportsTo" id="z_ReportsTo" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->ReportsTo->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_ReportsTo" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->ReportsTo->getInputTextType() ?>" name="x_ReportsTo" id="x_ReportsTo" data-table="theuserprofile" data-field="x_ReportsTo" value="<?= $Page->ReportsTo->getEditValue() ?>" size="30" placeholder="<?= HtmlEncode($Page->ReportsTo->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->ReportsTo->formatPattern()) ?>"<?= $Page->ReportsTo->editAttributes() ?>>
...
loadjs.ready(['ftheuserprofilesearch', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftheuserprofilesearch", "x_ReportsTo", jQuery.extend(true, "", options));
});
</script>
</span>
                </div>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <div id="r_Gender" class="row"<?= $Page->Gender->rowAttributes() ?>>
        <label for="x_Gender" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_Gender"><?= $Page->Gender->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_Gender" id="z_Gender" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Gender->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_Gender" class="ew-search-field ew-search-field-single">
    <select
        id="x_Gender"
        name="x_Gender"
        class="form-select ew-select<?= $Page->Gender->isInvalidClass() ?>"
        <?php if (!$Page->Gender->IsNativeSelect) { ?>
        data-select2-id="ftheuserprofilesearch_x_Gender"
        <?php } ?>
        data-table="theuserprofile"
        data-field="x_Gender"
...
<script<?= Nonce() ?>>
loadjs.ready("ftheuserprofilesearch", function() {
    var options = { name: "x_Gender", selectId: "ftheuserprofilesearch_x_Gender" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftheuserprofilesearch.lists.Gender?.lookupOptions.length) {
        options.data = { id: "x_Gender", form: "ftheuserprofilesearch" };
    } else {
        options.ajax = { id: "x_Gender", form: "ftheuserprofilesearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php if ($Page->_Email->Visible) { // Email ?>
    <div id="r__Email" class="row"<?= $Page->_Email->rowAttributes() ?>>
        <label for="x__Email" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile__Email"><?= $Page->_Email->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z__Email" id="z__Email" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->_Email->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile__Email" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->_Email->getInputTextType() ?>" name="x__Email" id="x__Email" data-table="theuserprofile" data-field="x__Email" value="<?= $Page->_Email->getEditValue() ?>" size="50" maxlength="255" placeholder="<?= HtmlEncode($Page->_Email->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->_Email->formatPattern()) ?>"<?= $Page->_Email->editAttributes() ?>>
...
<?php if ($Page->Activated->Visible) { // Activated ?>
    <div id="r_Activated" class="row"<?= $Page->Activated->rowAttributes() ?>>
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_Activated"><?= $Page->Activated->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_Activated" id="z_Activated" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Activated->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_Activated" class="ew-search-field ew-search-field-single">
<div class="form-check form-switch d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->Activated->isInvalidClass() ?>" data-table="theuserprofile" data-field="x_Activated" data-boolean name="x_Activated" id="x_Activated" value="1"<?= ConvertToBool($Page->Activated->AdvancedSearch->SearchValue) ? " checked" : "" ?><?= $Page->Activated->editAttributes() ?>>
...
<?php if ($Page->Avatar->Visible) { // Avatar ?>
    <div id="r_Avatar" class="row"<?= $Page->Avatar->rowAttributes() ?>>
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_Avatar"><?= $Page->Avatar->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Avatar" id="z_Avatar" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Avatar->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_Avatar" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Avatar->getInputTextType() ?>" name="x_Avatar" id="x_Avatar" data-table="theuserprofile" data-field="x_Avatar" value="<?= $Page->Avatar->getEditValue() ?>" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->Avatar->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Avatar->formatPattern()) ?>"<?= $Page->Avatar->editAttributes() ?>>
...
<?php if ($Page->ActiveStatus->Visible) { // ActiveStatus ?>
    <div id="r_ActiveStatus" class="row"<?= $Page->ActiveStatus->rowAttributes() ?>>
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_ActiveStatus"><?= $Page->ActiveStatus->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_ActiveStatus" id="z_ActiveStatus" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->ActiveStatus->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_ActiveStatus" class="ew-search-field ew-search-field-single">
<div class="form-check form-switch d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->ActiveStatus->isInvalidClass() ?>" data-table="theuserprofile" data-field="x_ActiveStatus" data-boolean name="x_ActiveStatus" id="x_ActiveStatus" value="1"<?= ConvertToBool($Page->ActiveStatus->AdvancedSearch->SearchValue) ? " checked" : "" ?><?= $Page->ActiveStatus->editAttributes() ?>>
...
<?php if ($Page->MessengerColor->Visible) { // MessengerColor ?>
    <div id="r_MessengerColor" class="row"<?= $Page->MessengerColor->rowAttributes() ?>>
        <label for="x_MessengerColor" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_MessengerColor"><?= $Page->MessengerColor->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_MessengerColor" id="z_MessengerColor" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->MessengerColor->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_MessengerColor" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->CreatedAt->Visible) { // CreatedAt ?>
    <div id="r_CreatedAt" class="row"<?= $Page->CreatedAt->rowAttributes() ?>>
        <label for="x_CreatedAt" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_CreatedAt"><?= $Page->CreatedAt->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("BETWEEN") ?>
<input type="hidden" name="z_CreatedAt" id="z_CreatedAt" value="BETWEEN">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->CreatedAt->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_CreatedAt" class="ew-search-field">
...
loadjs.ready(['ftheuserprofilesearch', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftheuserprofilesearch", "x_CreatedAt", jQuery.extend(true, "", options));
});
</script>
</span>
                    <span class="ew-search-and"><label><?= $Language->phrase("AND") ?></label></span>
                    <span id="el2_theuserprofile_CreatedAt" class="ew-search-field2">
<input type="<?= $Page->CreatedAt->getInputTextType() ?>" name="y_CreatedAt" id="y_CreatedAt" data-table="theuserprofile" data-field="x_CreatedAt" value="<?= $Page->CreatedAt->EditValue2 ?>" size="17" maxlength="19" placeholder="<?= HtmlEncode($Page->CreatedAt->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->CreatedAt->formatPattern()) ?>"<?= $Page->CreatedAt->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->CreatedAt->getErrorMessage(false) ?></div>
<?php if (!$Page->CreatedAt->ReadOnly && !$Page->CreatedAt->Disabled && !isset($Page->CreatedAt->EditAttrs["readonly"]) && !isset($Page->CreatedAt->EditAttrs["disabled"])) { ?>
<script<?= Nonce() ?>>
loadjs.ready(["ftheuserprofilesearch", "datetimepicker"], function () {
...
loadjs.ready(['ftheuserprofilesearch', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftheuserprofilesearch", "y_CreatedAt", jQuery.extend(true, "", options));
});
</script>
</span>
                </div>
...
<?php if ($Page->CreatedBy->Visible) { // CreatedBy ?>
    <div id="r_CreatedBy" class="row"<?= $Page->CreatedBy->rowAttributes() ?>>
        <label for="x_CreatedBy" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_CreatedBy"><?= $Page->CreatedBy->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_CreatedBy" id="z_CreatedBy" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->CreatedBy->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_CreatedBy" class="ew-search-field ew-search-field-single">
    <select
        id="x_CreatedBy"
        name="x_CreatedBy"
        class="form-select ew-select<?= $Page->CreatedBy->isInvalidClass() ?>"
        <?php if (!$Page->CreatedBy->IsNativeSelect) { ?>
        data-select2-id="ftheuserprofilesearch_x_CreatedBy"
        <?php } ?>
        data-table="theuserprofile"
...
<script<?= Nonce() ?>>
loadjs.ready("ftheuserprofilesearch", function() {
    var options = { name: "x_CreatedBy", selectId: "ftheuserprofilesearch_x_CreatedBy" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftheuserprofilesearch.lists.CreatedBy?.lookupOptions.length) {
        options.data = { id: "x_CreatedBy", form: "ftheuserprofilesearch" };
    } else {
        options.ajax = { id: "x_CreatedBy", form: "ftheuserprofilesearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumInputLength = ew.selectMinimumInputLength;
...
<?php if ($Page->UpdatedAt->Visible) { // UpdatedAt ?>
    <div id="r_UpdatedAt" class="row"<?= $Page->UpdatedAt->rowAttributes() ?>>
        <label for="x_UpdatedAt" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_UpdatedAt"><?= $Page->UpdatedAt->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("BETWEEN") ?>
...
loadjs.ready(['ftheuserprofilesearch', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftheuserprofilesearch", "x_UpdatedAt", jQuery.extend(true, "", options));
});
</script>
</span>
                    <span class="ew-search-and"><label><?= $Language->phrase("AND") ?></label></span>
                    <span id="el2_theuserprofile_UpdatedAt" class="ew-search-field2">
<input type="<?= $Page->UpdatedAt->getInputTextType() ?>" name="y_UpdatedAt" id="y_UpdatedAt" data-table="theuserprofile" data-field="x_UpdatedAt" value="<?= $Page->UpdatedAt->EditValue2 ?>" size="17" maxlength="19" placeholder="<?= HtmlEncode($Page->UpdatedAt->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->UpdatedAt->formatPattern()) ?>"<?= $Page->UpdatedAt->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->UpdatedAt->getErrorMessage(false) ?></div>
<?php if (!$Page->UpdatedAt->ReadOnly && !$Page->UpdatedAt->Disabled && !isset($Page->UpdatedAt->EditAttrs["readonly"]) && !isset($Page->UpdatedAt->EditAttrs["disabled"])) { ?>
<script<?= Nonce() ?>>
loadjs.ready(["ftheuserprofilesearch", "datetimepicker"], function () {
...
loadjs.ready(['ftheuserprofilesearch', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("ftheuserprofilesearch", "y_UpdatedAt", jQuery.extend(true, "", options));
});
</script>
</span>
                </div>
...
<?php if ($Page->UpdatedBy->Visible) { // UpdatedBy ?>
    <div id="r_UpdatedBy" class="row"<?= $Page->UpdatedBy->rowAttributes() ?>>
        <label for="x_UpdatedBy" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile_UpdatedBy"><?= $Page->UpdatedBy->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_UpdatedBy" id="z_UpdatedBy" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->UpdatedBy->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile_UpdatedBy" class="ew-search-field ew-search-field-single">
    <select
        id="x_UpdatedBy"
        name="x_UpdatedBy"
        class="form-select ew-select<?= $Page->UpdatedBy->isInvalidClass() ?>"
        <?php if (!$Page->UpdatedBy->IsNativeSelect) { ?>
        data-select2-id="ftheuserprofilesearch_x_UpdatedBy"
        <?php } ?>
        data-table="theuserprofile"
...
<script<?= Nonce() ?>>
loadjs.ready("ftheuserprofilesearch", function() {
    var options = { name: "x_UpdatedBy", selectId: "ftheuserprofilesearch_x_UpdatedBy" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftheuserprofilesearch.lists.UpdatedBy?.lookupOptions.length) {
        options.data = { id: "x_UpdatedBy", form: "ftheuserprofilesearch" };
    } else {
        options.ajax = { id: "x_UpdatedBy", form: "ftheuserprofilesearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumInputLength = ew.selectMinimumInputLength;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.theuserprofile.fields.UpdatedBy.selectOptions);
    ew.createSelect(options);
});
</script>
<?php } ?>
...
<?= $Page->IsModal ? '<template class="ew-modal-buttons">' : '<div class="row ew-buttons">' ?><!-- buttons .row -->
    <div class="<?= $Page->OffsetColumnClass ?>"><!-- buttons offset -->
        <button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="ftheuserprofilesearch"><?= $Language->phrase("Search") ?></button>
        <?php if ($Page->IsModal) { ?>
        <button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="ftheuserprofilesearch"><?= $Language->phrase("CancelBtn") ?></button>
        <?php } else { ?>
        <button class="btn btn-secondary ew-btn" name="btn-reset" id="btn-reset" type="button" form="ftheuserprofilesearch" data-ew-action="reload"><?= $Language->phrase("Reset") ?></button>
        <?php } ?>
    </div><!-- /buttons offset -->
