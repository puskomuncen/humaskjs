...
<?php if ($Page->_UserID->Visible) { // UserID ?>
        <th class="<?= $Page->_UserID->headerCellClass() ?>"><span id="elh_users__UserID" class="users__UserID"><?= $Page->_UserID->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->UserLevel->Visible) { // UserLevel ?>
        <th class="<?= $Page->UserLevel->headerCellClass() ?>"><span id="elh_users_UserLevel" class="users_UserLevel"><?= $Page->UserLevel->caption() ?></span></th>
<?php } ?>
<?php if ($Page->CompleteName->Visible) { // CompleteName ?>
        <th class="<?= $Page->CompleteName->headerCellClass() ?>"><span id="elh_users_CompleteName" class="users_CompleteName"><?= $Page->CompleteName->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->ActiveStatus->Visible) { // ActiveStatus ?>
        <th class="<?= $Page->ActiveStatus->headerCellClass() ?>"><span id="elh_users_ActiveStatus" class="users_ActiveStatus"><?= $Page->ActiveStatus->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
