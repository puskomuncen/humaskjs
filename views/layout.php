...
{{if items}}
    <ul class="nav nav-pills nav-sidebar nav-child-indent nav-legacy flex-column{{if compact}} nav-compact{{/if}}" data-widget="treeview" role="menu" data-accordion="{{:accordion}}">
        ...
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none" href="#" data-ew-action="none">
                    <span class="brand-text">HUMAS UNCEN</span>
                </a>
            </ul>
            <!-- Right navbar links -->
