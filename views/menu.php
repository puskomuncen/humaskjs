...
$sideMenu->addMenuItem(45, "mi_mitra", $Language->menuPhrase("45", "MenuText"), "mitralist", 40, substr("mi_mitra", strpos("mi_mitra", "mi_") + 3), AllowListMenu('{48315587-314B-49E3-9526-BFD08EAC1CB1}mitra'), false, false, "fa-file", "", false, true);
