...
$sideMenu->addMenuItem(44, "mi_kontak_mitra", $Language->menuPhrase("44", "MenuText"), "kontakmitralist", 40, substr("mi_kontak_mitra", strpos("mi_kontak_mitra", "mi_") + 3), AllowListMenu('{48315587-314B-49E3-9526-BFD08EAC1CB1}kontak_mitra'), false, false, "fa-file", "", false, true);
$sideMenu->addMenuItem(43, "mi_kerjasama", $Language->menuPhrase("43", "MenuText"), "kerjasamalist", 40, substr("mi_kerjasama", strpos("mi_kerjasama", "mi_") + 3), AllowListMenu('{48315587-314B-49E3-9526-BFD08EAC1CB1}kerjasama'), false, false, "fa-file", "", false, true);
...
$sideMenu->addMenuItem(41, "mi_event", $Language->menuPhrase("41", "MenuText"), "eventlist", 39, substr("mi_event", strpos("mi_event", "mi_") + 3), AllowListMenu('{48315587-314B-49E3-9526-BFD08EAC1CB1}event'), false, false, "fa-file", "", false, true);
$sideMenu->addMenuItem(46, "mi_publikasi", $Language->menuPhrase("46", "MenuText"), "publikasilist", 39, substr("mi_publikasi", strpos("mi_publikasi", "mi_") + 3), AllowListMenu('{48315587-314B-49E3-9526-BFD08EAC1CB1}publikasi'), false, false, "fa-file", "", false, true);
$sideMenu->addMenuItem(42, "mi_interaksi", $Language->menuPhrase("42", "MenuText"), "interaksilist", 39, substr("mi_interaksi", strpos("mi_interaksi", "mi_") + 3), AllowListMenu('{48315587-314B-49E3-9526-BFD08EAC1CB1}interaksi'), false, false, "fa-file", "", false, true);
$sideMenu->addMenuItem(45, "mi_mitra", $Language->menuPhrase("45", "MenuText"), "mitralist", 39, substr("mi_mitra", strpos("mi_mitra", "mi_") + 3), AllowListMenu('{48315587-314B-49E3-9526-BFD08EAC1CB1}mitra'), false, false, "fa-file", "", false, true);
